...
const Credential$json = const {
  ...
  '2': const [
    ...
    const {'1': 'oauthtype', '3': 3, '4': 1, '5': 14, '6': '.goprotonyom.OAuthType', '10': 'oauthtype'},
    const {'1': 'oauthid', '3': 4, '4': 1, '5': 9, '10': 'oauthid'},
  ],
};

/// Descriptor for `Credential`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List credentialDescriptor = $convert.base64Decode('CgpDcmVkZW50aWFsEg4KAmlkGAEgASgJUgJpZBIaCghwYXNzd29yZBgCIAEoCVIIcGFzc3dvcmQSNAoJb2F1dGh0eXBlGAMgASgOMhYuZ29wcm90b255b20uT0F1dGhUeXBlUglvYXV0aHR5cGUSGAoHb2F1dGhpZBgEIAEoCVIHb2F1dGhpZA==');
...
const Account$json = const {
  ...
  '2': const [
    ...
    const {'1': 'oauthtype', '3': 5, '4': 1, '5': 14, '6': '.goprotonyom.OAuthType', '10': 'oauthtype'},
...
final $typed_data.Uint8List accountDescriptor = $convert.base64Decode('');
...
const Feeds$json = const {
  '1': 'Feeds',
  '2': const [
    const {'1': 'feeds', '3': 1, '4': 3, '5': 11, '6': '.goprotonyom.Feed', '10': 'feeds'},
  ],
};

/// Descriptor for `Feeds`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List feedsDescriptor = $convert.base64Decode('CgVGZWVkcxInCgVmZWVkcxgBIAMoCzIRLmdvcHJvdG9ueW9tLkZlZWRSBWZlZWRz');
